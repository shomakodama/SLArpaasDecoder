...
const std::string fname = "data_rate/rate_8ch_1024.dat"; // need to be changed
const TString ofilename = "root_rate/rate_8ch_1024.root"; // need to be changed
        ...
        while (getline(fs, tmp)) {
            ...
            if(Data == 10){ // header!
                ...
                if(event != -1){ // new event!
                    ...
                    eventflag = std::max({eventflag0, eventflag1, eventflag2, eventflag3, eventflag4, eventflag5, eventflag6, eventflag7});
            ...
            // eventline = 3, 4, 5 -> 1
            // eventline = 6, 7, 8 -> 2
            if(eventline%4 == 0){ // eventline = 0, 4, 8, ...
                ADC1[eventline/4] = ADC_1;
                ADC0[eventline/4] = ADC_2;
            }else if(eventline%4 == 1){ // eventline = 1, 5, 9, ...
                ADC3[eventline/4] = ADC_1;
                ADC2[eventline/4] = ADC_2;
            }else if(eventline%4 == 2){ // eventline = 2, 6, 10, ...
                ADC5[eventline/4] = ADC_1;
                ADC4[eventline/4] = ADC_2;
            }else if(eventline%4 == 3){ // eventline = 3, 7, 11, ...
                ADC7[eventline/4] = ADC_1;
                ADC6[eventline/4] = ADC_2;
            }
