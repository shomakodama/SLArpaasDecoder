...
const std::string fname = "data_rate/rate_4ch_1024.dat"; // need to be changed
const TString ofilename = "root_rate/rate_4ch_1024.root"; // need to be changed
        ...
        while (getline(fs, tmp)) {
            ...
            if(Data == 10){ // header!
                ...
                if(event != -1){ // new event!
                    ...
                    eventflag = std::max({eventflag0, eventflag1, eventflag2, eventflag3});
            ...
            // eventline = 3, 4, 5 -> 1
            // eventline = 6, 7, 8 -> 2
            if(eventline%2 == 0){ // eventline = 0, 2, 4, ...
                ADC1[eventline/2] = ADC_1;
                ADC0[eventline/2] = ADC_2;
            }else if(eventline%2 == 1){ // eventline = 1, 3, 5, ...
                ADC3[eventline/2] = ADC_1;
                ADC2[eventline/2] = ADC_2;
            }
